...
```html
<input type="text" name="dob" data-val-rules="required" data-val-dispaly="Date of birth">
```
...
```html
<input type="tel" name="phone" id="phone" data-val-rules="numeric|uk_phonenumber" data-val-allow-empty="true">
```
...
```html
<input type="text" name="dob" data-val-rules="required|years_between[17]" data-val-with="inception">
<input type="text" name="dob" data-val-rules="required|years_between[17]" data-val-with="dob">
```
